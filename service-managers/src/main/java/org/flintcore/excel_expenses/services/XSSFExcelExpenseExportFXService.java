...
import org.flintcore.excel_expenses.configurations.builders.XSSFExpenseFileBuilderService;
import org.flintcore.excel_expenses.configurations.builders.XSSFWorkbookManagerService;
import org.flintcore.excel_expenses.configurations.receipts.ReceiptFileFXService;
...
public class XSSFExcelExpenseExportFXService extends Service<Boolean> {
    ...
    private final ReceiptFileFXService receiptFileService;
    ...
    public XSSFExcelExpenseExportFXService(
            ReceiptFileFXService receiptFileService,
