package org.flintcore.excel_expenses.excels_handler.models.events;
...
public final class TaskFxEvent extends WorkerStateEvent {
    public static final List<EventType<WorkerStateEvent>> ALL_WORKER_STATE_DONE = List.of(
            WORKER_STATE_SUCCEEDED, WORKER_STATE_FAILED, WORKER_STATE_CANCELLED
    );
