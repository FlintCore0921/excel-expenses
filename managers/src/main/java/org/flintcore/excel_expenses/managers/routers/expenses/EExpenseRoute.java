...
import static org.flintcore.excel_expenses.managers.properties.CompoundResourceBundle.Bundles.*;

@AllArgsConstructor
@Getter
public enum EExpenseRoute implements IRoute {
    CREATE(
            "/templates/createExpenseForm.fxml",
            new Bundles[]{ EXPENSE_CREATE_FORM }
    );
